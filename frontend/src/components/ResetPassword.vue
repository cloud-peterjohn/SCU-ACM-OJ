<template>
    ...
    <div class="demo-login">
          <Login @on-submit="handleSubmitReset" >
              ...
              <Password type="password" name="password" placeholder="请输入新密码（至少六位）" />
  ...
  <script>
      ...
      export default {
          ...
          methods: {
              handleSubmitReset (valid, { email: mail, password: pass_word, passwordAgain: password_Again, captcha: captcha_value }) {
                  if (valid) {
                      this.email = mail;
                      ...
                      this.$Modal.info({
                          title: '请确认您的更改密码信息：',
                          content: 'email: ' + mail + ' | password: ' + pass_word + ' | passwordAgain: ' + password_Again + ' | captcha: ' + captcha_value,
                            onOk: () => {
