...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            handleView(row) {
                this.recentContestTitle = row.contestTitle
                this.get_contest();
            },
            submit(){
            ...
            get_contest(){
                console.log(this.recentContestTitle)
                axios.post('/api/contest/findByTitle', 
                    new URLSearchParams({
                        title: this.recentContestTitle
                    })  
                )
                .then(res => {
                    console.log(res.data.data);
                    this.recentContestID = res.data.data.id;
                    this.recentContestStartTime = new Date(res.data.data.startTime);
                    this.recentContestEndTime = new Date(res.data.data.endTime);
                    this.recentContestCreateTime = new Date(res.data.data.createTime);
                })
                .catch(err => {
                    console.log(err);
        ...
        mounted() {
            axios.get('/api/contest/findByUserId', 
            new URLSearchParams(
                {
            ...
            .then(res => {
                ...
                this.contestList = res.data.data.map(contest=>({
